<x-layout :doctitle="$doctitle">
    <div class="container py-md-5 container--narrow">
        ...
        <div class="profile-nav nav nav-tabs pt-2 mb-4">
            ...
            <a href="/profile/{{$sharedData['username']}}/followers" class="profile-nav-link nav-item nav-link {{ Request::segment(3) == "" ? "followers" : "" }}">Followers : {{$sharedData['followerCount']}}</a>
            <a href="/profile/{{$sharedData['username']}}/following" class="profile-nav-link nav-item nav-link {{ Request::segment(3) == "" ? "following" : "" }}">Following : {{$sharedData['followingCount']}}</a>
        </div>
